        ...
        >
          ...
          >
            ...
            <div className="bg-[#601131] text-white rounded-t-2xl px-6 py-5 relative">
              <h2 className="text-xl font-bold pr-8">Now Hiring: Restaurant Manager</h2>
            ...
            <div className="px-6 py-5 space-y-5 text-sm leading-relaxed">
              ...
              <div className="bg-[#601131]/5 border border-[#601131]/20 rounded-xl p-4">
                ...
                <a
                  href="mailto:tymalabar@gmail.com?subject=Restaurant Manager Application"
                ...
                <p className="text-xs text-gray-500 mt-2">Subject line: Restaurant Manager Application – [Your Name]</p>
              </div>
            </div>
          </div>
        </div>
